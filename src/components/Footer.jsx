  ...
  return (
    <div>
      <section className="Section-about">
        <div>
          <p>Online Supermarket, Delivery In Karachi, Pakistan</p>
          <p>
      ...
      <section className="section-blank"></section>
      ...
      <footer>
        <div>
          <div className="columns">
            ...
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">Sell on HumMart</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">Terms & Conditions</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
          ...
          <div className="columns">
            ...
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">How to Order</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">How to Pay</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">Return & Refunds</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
            ...
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">Delivery</span>
            </div>
            <div>
              <ion-icon name="caret-forward-outline"></ion-icon>
              <span className="hover">Easy Paisa</span>
            </div>
          </div>
          <div className="columns">
            ...
            <div>
              <p>PHONE</p>
              <span>(021) 111 116 278</span>
            </div>
            <div>
              <p>EMAIL</p>
              <span>customer@hummart.com</span>
            </div>
            <div>
          ...
          <div className="columns">
            ...
            {/* <!-- <div className="footer-ImgDiv"><img src="" alt=""></div> --> */}
          </div>
        </div>
        <p>© Hummart.com 2020. All Rights Reserved Powered By Matech CO</p>
      </footer>
    </div>
  );
};
